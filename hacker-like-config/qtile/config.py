...
keys = [
    ...
    # Open widgets
    Key([mod], "n", lazy.spawn("~/.config/eww/sidebar/toggle-sidedar")),
    Key([mod], "m", lazy.spawn("~/.config/eww/scripts/open_system")),
...
automatic = [
    ...
    'feh --randomize --bg-scale /home/kaizuser/Pictures/',
    'picom &',
    'sudo alacritty -e "cava"'
]
